(function($) {
    ...
    /**
     * add Event handler to a element
     *
     ...
     * 
     */
    SandBox.prototype.addEventHandler = function(element, evt, handler) {
    	...
    	addEventHandler(element, evt, handler);
    };

    /**
     * remove Event handler to a element
     *
     * @param {object} element
     * @param {string} evt
     * @param {function} handler
     * 
     */
    SandBox.prototype.removeEventHandler = function(element, evt, handler) {
    	...
    	removeEventHandler(element, evt, handler);
    };
